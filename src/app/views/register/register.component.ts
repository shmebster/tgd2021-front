...
export class RegisterComponent implements OnInit {
  ...
  Позвольте представиться, меня зовут Шаалиса (это как алиса только шальная) и сегодня я буду вести эту игру.
  <break time="1s"/>та-дааам!
  ...
  Потому что впереди ждут каверзные вопросы, да начнеться мясо<break time="3s" />
  Даа<break time="1s"/>, кстаати<break time="1s"/>. Про правила я расскажу чуть позже, шаг по шагу давай
  <break time="2s" />
  И кстати, большое всем спасибо что вы приехали. Я приложу все усилия чтобы этот вечер был легеееен<break time="1s"/> подожди-подожди<break time="3s"/>дарным
  ленегдарным или как там, нуу вы поняли. 
</speak>`);
